...
func ValidateSchedule(s Schedule) error {
	if (s.Protocol != "openai_chat" && s.Protocol != "openai_responses" && s.Protocol != "anthropic_messages") || (s.ContextThreshold != 0 && s.ContextThreshold != 128000 && s.ContextThreshold != 200000) {
		return ErrInvalid
	}
